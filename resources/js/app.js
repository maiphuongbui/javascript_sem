...
function playerNumberSelect() {
    $('.list-item').click(function () {
        ...
        document.getElementById('playerForm').innerHTML = formNumber;
    });
}
